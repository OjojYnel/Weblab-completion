<%-- 
    Document   : completed
    Created on : 26-Dec-2018, 17:07:17
...
<html>
    ...
    <form>
        ...
        <table>
            ...
            String data; 
            if(query!=null){
                data = "SELECT transactionId, status, flower FROM transaction where status = 'completed' AND (transactionId like '%"+query+"%' or flower like '%"+query+"%')";
            }else{
                data = "SELECT transactionId, status, flower FROM transaction where status = 'completed'";
            }
